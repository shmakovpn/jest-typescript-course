...
Скрипты обладают наибольшей гибкостью, но их сложнее писать, не самый подходящий вариант для новичка.
...
Можно воспользоваться мастером создания конфигурации, выполнив команду `jest --init`.
При этом `jest` будет задавать множество непонятных вопросов и создаст довольно большой файл.
Поэкспериментируйте с `jest --init`, давая разные ответы. 
