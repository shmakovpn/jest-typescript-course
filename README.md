...
- во-вторых у него есть side-эффект в виде вывода *oops* в терминал. Нам надо знать работает код или нет, результат его работы нам совершенно ни к чему. Напротив, он создает лишний информационный шум на выходе теста.
